...
HEADERS += radiogroup.h roiimage.h radialgraph.h
HEADERS += colors.h roiimages.h coherence.h
...
SOURCES += radiogroup.cpp roiimage.cpp radialgraph.cpp
SOURCES += colors.cpp roiimages.cpp coherence.cpp
