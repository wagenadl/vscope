...
public:
  ...
  virtual ~VideoGUI();
  bool openPage(class guiRoot *gui, class ParamTree *ptree);
  /*:F openPage
   ...
   */
  bool reset(class guiRoot *gui, class ParamTree *ptree);
  /*:F reset
   *:D Rebuilds gui and prog from ptree.
   *:R True if successful. If not, a GUI warning is emitted and the
       "Enable" button is switched off.
   */
  bool changeEnable(class guiRoot *gui, class ParamTree *ptree);
  bool changeProgram(class guiRoot *gui, class ParamTree *ptree);
  bool changeParam(class guiRoot *gui, class ParamTree *ptree, QString parid);
   ...
   */
private:
  void ensureGUI(class guiRoot *gui, class ParamTree *ptree);
  /*:F ensureGUI
